...
const CHAPTERS: Chapter[] = [
  {
    ...
    screen: { src: asset('/assets/hud-dashboard.webp'), alt: 'RYDYT HUD navigation dashboard', label: 'Navigation Sync' },
    speed: '64',
    eta: '11:40',
  },
  {
    ...
    screen: { src: asset('/assets/hud-pinmap.webp'), alt: 'Pinned fuel stop on the route map', label: 'Smart Stops' },
    speed: '96',
    eta: '11:32',
  },
  {
    ...
    screen: { src: asset('/assets/hud-riders.webp'), alt: 'Live rider tracking on map', label: 'Live Tracking' },
    speed: '41',
    eta: '13:05',
  },
  {
    ...
    screen: { src: asset('/assets/hud-call.webp'), alt: 'Group intercom call module', label: 'Voice Intercom' },
    speed: '58',
    eta: '15:48',
  },
  {
    ...
    screen: { src: asset('/assets/hud-sos.webp'), alt: 'SOS emergency screen', label: 'Emergency SOS' },
    speed: '0',
    eta: '—',
  },
  {
